...
const EditEventForm = ({ event, onClose, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 min-h-screen bg-[#0F172A]/90 backdrop-blur-md z-50 overflow-y-auto">
      {/* Close button at top */}
      <div className="absolute top-4 right-4">
        <button 
          onClick={onClose} 
          className="p-2 bg-[#1E293B] hover:bg-[#1E293B]/80 rounded-full 
            transition-colors border border-[#38BDF8]/20 
      ...
      {/* Main content */}
      <div className="container max-w-3xl mx-auto px-4 py-8 mb-16"> {/* Changed pb-16 to mb-16 */}
      <div className="bg-[#1E293B]/80 backdrop-blur-sm rounded-2xl p-8 
        border border-[#38BDF8]/20 shadow-[0_0_30px_rgba(56,189,248,0.2)]">
          <h2 className="text-3xl font-bold text-[#F1F5F9] mb-8 text-center relative">
            Edit Event
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <label 
                  htmlFor="imageUpload"
                  className="block w-full p-6 border-2 border-dashed border-[#38BDF8]/30 
            ...
            <div className="space-y-6">
              ...
              <input
                ...
                className="w-full p-4 bg-[#0F172A]/50 border border-[#38BDF8]/20 rounded-xl
              ...
              {/* Submit Button */}
              <div className="mt-8"> {/* Changed pt-4 to mt-8 */}
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#38BDF8] to-[#F59E0B]
                text-[#0F172A] font-semibold py-4 rounded-xl
